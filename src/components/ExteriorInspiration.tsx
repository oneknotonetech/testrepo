...
import { exteriorItems } from '@/data/exteriorItems';

interface ExteriorInspirationProps {
  wishlistIds: string[];
...
const ExteriorInspiration: React.FC<ExteriorInspirationProps> = ({
  wishlistIds,
  toggleWishlist,
  setPreviewItem,
  setPreviewIndex
  ...
  useEffect(() => {
    if (searchQuery) {
      ...
      setFilteredItems(
        exteriorItems.filter((item: InspirationItem) =>
      ...
      setFilteredItems(exteriorItems);
    }
  }, [searchQuery]);
      ...
      >
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search for exterior inspiration by name, style, or keywords..."
            value={searchQuery}
        ...
        >
          {filteredItems.length > 0 ? (
            ...
            <motion.div 
              ...
              animate={{ opacity: 1 }}
            >
              <p className="text-gray-500">No exterior inspiration found. Try adjusting your search.</p>
            </motion.div>
          )}
        </motion.div>
      </AnimatePresence>
...
export default ExteriorInspiration;
