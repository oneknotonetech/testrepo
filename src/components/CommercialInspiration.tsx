...
import { commercialItems } from '@/data/commercialItems';

interface CommercialInspirationProps {
  wishlistIds: string[];
...
const CommercialInspiration: React.FC<CommercialInspirationProps> = ({
  wishlistIds,
  toggleWishlist,
  setPreviewItem,
  setPreviewIndex
  ...
  useEffect(() => {
    if (searchQuery) {
      ...
      setFilteredItems(
        commercialItems.filter((item: InspirationItem) =>
      ...
      setFilteredItems(commercialItems);
    }
  }, [searchQuery]);
      ...
      >
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search for commercial inspiration by name, style, or keywords..."
            value={searchQuery}
        ...
        >
          {filteredItems.length > 0 ? (
            ...
            <motion.div 
              ...
              animate={{ opacity: 1 }}
            >
              <p className="text-gray-500">No commercial inspiration found. Try adjusting your search.</p>
            </motion.div>
          )}
        </motion.div>
      </AnimatePresence>
...
export default CommercialInspiration;
